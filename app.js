...
const { controller_vartotojas_create,controller_vartotojas_add_skelbimas_to_current_vartotojas_patikusiu_sarasas,
     controller_vartotojas_read_current_vartotojas_patikusiu_sarasas, 
     controller_vartotojas_remove_skelbimas_from_current_vartotojas_patikusiu_sarasas } = require("./controllers/controller_vartotojas")
...
const { controller_skelbimas_create, controller_skelbimas_search, controller_skelbimas_read, 
controller_skelbimas_add_komentaras, controller_skelbimas_update,controller_skelbimas_delete,
controller_skelbimas_delete_komentaras } = require("./controllers/controller_skelbimas")
